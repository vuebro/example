<template>
  ...
  <div
    class="flex flex-col gap-8 items-center bg-neutral-200 pa-12 not-prose"
    un-cloak
  >
    <el-button-group>
...
<script setup>
import "https://unpkg.com/element-plus@2.8.7/dist/index.css";
import ElementPlus from "element-plus";
import { AlarmClock } from "@element-plus/icons-vue";
import { computed, inject } from "vue";
window.app.use(ElementPlus.default);
const { id } = defineProps(["id"]);
const { title, description, $children } = inject("pages")[id];
